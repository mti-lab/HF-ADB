...
class SER_FIQ:
    ...
    def __init__(self,
        ...
        self.insightface = gluon.nn.SymbolBlock.imports(
                                    "./metrics/ser-fiq/insightface/model/insightface-symbol.json",
                                    ['data'],
                                    "./metrics/ser-fiq/insightface/model/insightface-0000.params", 
                                    ctx=self.device
                           )
        ...
        self.detector = mtcnn_detector.MtcnnDetector(model_folder="./metrics/ser-fiq/insightface/mtcnn-model/", 
                                                    ctx=self.device, 
                                                    num_worker=1, 
